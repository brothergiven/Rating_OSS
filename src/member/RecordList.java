...
public class RecordList {
	...
	void readRecords() { // RecordList에 불러오는 최초 작업
		try(BufferedReader br = new BufferedReader(new FileReader(LIST_FILE_NAME))){
			String line;
	...
	private void writeRecords() { // recordList에 있는 모든 기록 파일에 덮어쓰기
		try(BufferedWriter bw = new BufferedWriter(new FileWriter(LIST_FILE_NAME, false))){ // 덮어쓰기
